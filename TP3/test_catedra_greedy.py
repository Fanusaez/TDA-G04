...
def test_ejemplo_10_varios():
    # k optimo = 6
    _, subconjunto = parsear_archivo('sets-catedra/10_varios.txt')
...
def test_ejemplo_15():
    # k optimo = 4
    _, subconjunto = parsear_archivo('sets-catedra/15.txt')
    assert hitting_set_greedy([], subconjunto) == ['Luka Romero', 'Di Maria', 'Colo Barco', 'Dybala', 'Palermo']


def test_ejemplo_20():
    # k optimo = 5
    _, subconjunto = parsear_archivo('sets-catedra/20.txt')
...
def test_ejemplo_50():
    # k optimo = 6
    _, subconjunto = parsear_archivo('sets-catedra/50.txt')
...
def test_ejemplo_75():
    # k optimo = 8
    _, subconjunto = parsear_archivo('sets-catedra/75.txt')
...
def test_ejemplo_100():
    # k optimo = 9
    _, subconjunto = parsear_archivo('sets-catedra/100.txt')
...
def test_ejemplo_200():
    # k optimo = 9
    _, subconjunto = parsear_archivo('sets-catedra/200.txt')
